			...
			>
				...
				<ul className="nav flex-column">
					<li className="nav-item">
						<Link className="nav-link" to="/dashboard" style={{ color: "white", fontWeight:"600", fontSize:"20px" }}>
							Dashboard
						</Link>
					</li>
					<li className="nav-item">
						<Link className="nav-link" to="/inquiries" style={{ color: "white", fontWeight:"600", fontSize:"20px" }}>
							Inquiries
						</Link>
					</li>
					<li className="nav-item">
					...
					<li className="nav-item">
						<Link className="nav-link" to="/uploadProjectImg" style={{ color: "white", fontWeight:"600", fontSize:"20px" }}>
							UploadProjectImage
						</Link>
					</li>
					<li className="nav-item">
